...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.memorySearch.local.gpu":
    'GPU backend policy for local node-llama-cpp embeddings. "auto" keeps the package default, "metal" requests Metal on supported Macs, and "cpu" disables GPU offload where the installed build supports it.',
